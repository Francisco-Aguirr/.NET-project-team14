...
namespace BookingSystem.Web.Migrations
{
    ...
    [Migration("20260409030756_AddAppointmentStatusAndCreatedAt")]
    partial class AddAppointmentStatusAndCreatedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingSystem.Web.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BookingSystem.Web.Data.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("EmployeeId", "AppointmentStart", "AppointmentEnd");
            ...
            modelBuilder.Entity("BookingSystem.Web.Data.EntrepreneurRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BookingSystem.Web.Data.Appointment", b =>
                {
                    b.HasOne("BookingSystem.Web.Data.BusinessService", "BusinessService")
                        .WithMany()
